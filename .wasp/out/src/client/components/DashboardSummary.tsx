    ...
    >
      ...
      {totalActions > 0 && (
        <a
          ...
          className="relative mt-5 inline-flex items-center gap-1.5 rounded-lg px-1 py-0.5 text-xs font-bold uppercase tracking-widest text-primary-strong transition-colors hover:underline cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
        >
...
const SummaryChip = ({
  ...
  <div
    className={cn(
      ...
      tone === 'success' && 'border-success/30 bg-success/10 text-success-strong',
      tone === 'warning' && 'border-warning/30 bg-warning/10 text-warning-strong',
