...
import upsertModeleHoraire from './upsertModeleHoraire.js'
import deleteModeleHoraire from './deleteModeleHoraire.js'
import genererPlanning from './genererPlanning.js'
import reconduirePlanning from './reconduirePlanning.js'
import appliquerSuggestion from './appliquerSuggestion.js'
import soumettreAvis from './soumettreAvis.js'
import completerSoumission from './completerSoumission.js'
...
import declencherAnalyseGlobale from './declencherAnalyseGlobale.js'
...
import getModelesHoraires from './getModelesHoraires.js'
import suggererPlanning from './suggererPlanning.js'
...
router.post('/upsert-modele-horaire', auth, upsertModeleHoraire)
router.post('/delete-modele-horaire', auth, deleteModeleHoraire)
router.post('/generer-planning', auth, genererPlanning)
router.post('/reconduire-planning', auth, reconduirePlanning)
router.post('/appliquer-suggestion', auth, appliquerSuggestion)
router.post('/soumettre-avis', auth, soumettreAvis)
router.post('/completer-soumission', auth, completerSoumission)
...
router.post('/declencher-analyse-globale', auth, declencherAnalyseGlobale)
...
router.post('/get-modeles-horaires', auth, getModelesHoraires)
router.post('/suggerer-planning', auth, suggererPlanning)
