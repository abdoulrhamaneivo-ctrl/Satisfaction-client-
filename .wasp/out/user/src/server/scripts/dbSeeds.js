 ...
 */
export async function seedEntrepriseUnique(prismaClient) {
    ...
    if (entrepriseCount === 0) {
        ...
        if (entrepriseCount > 1) {
            console.warn(`ATTENTION : ${entrepriseCount} entreprises détectées en base de données ` +
...
// ============================================================================
export async function seedSuperAdmin(prismaClient) {
