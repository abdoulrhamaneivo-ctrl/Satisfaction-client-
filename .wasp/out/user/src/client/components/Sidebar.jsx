...
import { Inbox, Calendar, Store, Users, Settings, LayoutDashboard, SlidersHorizontal, Building2, Archive, MessageSquareQuote, Search, LogOut, ShieldCheck, } from 'lucide-react';
        ...
        <div className="p-4 border-t border-border/70 space-y-3 bg-muted/20 mt-auto">
          ...
          <div className="flex items-center justify-between gap-1 pt-1">
            <div className="flex items-center gap-1">
              <DarkModeSwitcher />
              <button type="button" onClick={() => logout()} title="Se deconnecter" aria-label="Se deconnecter" className="size-9 rounded-xl flex items-center justify-center text-muted-foreground hover:text-destructive hover:bg-destructive/10 border border-transparent hover:border-destructive/20 transition-all cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/40">
