...
import { useQuery, getReponses, getRadarStats, getAlertes, getTachesCorrectives, getTendanceMensuelle, getStatsByAgent, getStatsByGuichet, getActionsPrioritaires, getKPIsPeriode, getObjectifs, getHeatmapReponses, getComparaisonAgences, getTempsTraitement, getThemesStats, } from 'wasp/client/operations';
                      ...
                      <div className="flex items-center justify-between gap-3">
                        <div className="min-w-0">
                          <p className="truncate text-sm font-bold font-satoshi text-foreground">
                            {a.nom_agence}
                            {comparaisonAgences.meilleure_agence === a.nom_agence && a.nb_avis > 0 && (<span className="ml-2 rounded-full bg-success/10 px-2 py-0.5 text-[10px] font-bold uppercase tracking-widest text-success">Meilleure</span>)}
                            {comparaisonAgences.agence_a_surveiller === a.nom_agence && a.nb_avis > 0 && comparaisonAgences.agences.filter((x) => x.nb_avis > 0).length > 1 && (<span className="ml-2 rounded-full bg-warning/10 px-2 py-0.5 text-[10px] font-bold uppercase tracking-widest text-warning">À surveiller</span>)}
                          </p>
