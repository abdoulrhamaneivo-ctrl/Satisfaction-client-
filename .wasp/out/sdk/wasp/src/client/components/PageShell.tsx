...
export const PageTopNav = ({ racine, agence, actuel, onglets }: PageTopNavProps) => (
  <nav
    aria-label="Fil d'Ariane et navigation secondaire"
    className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-border/70 pb-4"
  >
