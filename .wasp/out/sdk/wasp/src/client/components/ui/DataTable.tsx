...
export const DataTableRow = ({
  ...
  return (
    <tr
      ...
      tabIndex={tabIndex ?? (activable ? 0 : undefined)}
      aria-label={ariaLabel}
      onKeyDown={(event) => {
        onKeyDown?.(event);
      ...
      className={cn(
        ...
        activable && "cursor-pointer active:bg-primary/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-ring",
        className
      )}
    >
      {children}
