...
import { Building2, ShieldCheck, ScrollText, LogOut, Menu, X, ArrowLeft, UserRound } from 'lucide-react'
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        <header className="flex items-center justify-between border-b border-white/10 px-4 py-3 md:px-8">
          ...
          <div className="ml-auto flex items-center gap-3">
            ...
            <Link
              to="/account"
              title="Mon compte — mot de passe, nom, e-mail"
              aria-label="Mon compte — mot de passe, nom, e-mail"
              className="flex items-center gap-2.5 rounded-xl px-2 py-1.5 transition-colors hover:bg-white/5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-warning/50"
            >
