...
// PUBLIC API
export const demanderReinitialisation = createAuthenticatedOperation(demanderReinitialisation_ext, {
    User: prisma.user,
    Invitation: prisma.invitation,
});
// PUBLIC API
...
// PUBLIC API
export const definirAgencePilotee = createAuthenticatedOperation(definirAgencePilotee_ext, {
    Agence: prisma.agence,
    User: prisma.user,
    Entreprise: prisma.entreprise,
});
// PUBLIC API
export const retirerAgencePilotee = createAuthenticatedOperation(retirerAgencePilotee_ext, {
    User: prisma.user,
    Entreprise: prisma.entreprise,
});
// PUBLIC API
