...
export declare const upsertModeleHoraire: ActionFor<UpsertModeleHoraire_ext>;
export declare const deleteModeleHoraire: ActionFor<DeleteModeleHoraire_ext>;
export declare const genererPlanning: ActionFor<GenererPlanning_ext>;
export declare const reconduirePlanning: ActionFor<ReconduirePlanning_ext>;
export declare const appliquerSuggestion: ActionFor<AppliquerSuggestion_ext>;
export declare const soumettreAvis: ActionFor<SoumettreAvis_ext>;
export declare const completerSoumission: ActionFor<CompleterSoumission_ext>;
...
export declare const demanderReinitialisation: ActionFor<DemanderReinitialisation_ext>;
...
export declare const definirAgencePilotee: ActionFor<DefinirAgencePilotee_ext>;
export declare const retirerAgencePilotee: ActionFor<RetirerAgencePilotee_ext>;
...
export declare const declencherAnalyseGlobale: ActionFor<DeclencherAnalyseGlobale_ext>;
