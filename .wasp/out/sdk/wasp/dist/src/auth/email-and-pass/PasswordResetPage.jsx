...
export function PasswordResetPage() {
    return (<AuthPageLayout eyebrow="Mot de passe oublié" title="Ce lien n'est plus utilisé" subtitle="Demandez un nouveau lien : vous recevrez un e-mail pour définir directement votre mot de passe." footer={<WaspRouterLink to={routes.LoginRoute.to} className="font-semibold text-primary underline decoration-primary/30 underline-offset-2 hover:decoration-primary">
      ...
      <div role="status" className="flex items-start gap-3 rounded-xl border border-primary/20 bg-primary/5 p-4 text-sm text-foreground">
        ...
        <p>
          ...
          <WaspRouterLink to={routes.RequestPasswordResetRoute.to} className="font-semibold text-primary underline decoration-primary/30 underline-offset-2 hover:decoration-primary">
