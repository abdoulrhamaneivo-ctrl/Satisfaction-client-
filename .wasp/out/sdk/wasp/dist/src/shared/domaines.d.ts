...
export declare const estTypeReponse: (v: unknown) => v is "SMILEY" | "OUI_NON" | "ECHELLE" | "QCM" | "CASES" | "TEXTE" | "NPS";
export declare const estScoringMode: (v: unknown) => v is "SMILEY" | "NPS" | "ORDINAL" | "BINARY" | "NUMERIC" | "CASES_CATEGORICAL" | "CASES_WEIGHTED" | "CES" | "FREE_TEXT";
...
export declare const estStatutIa: (v: unknown) => v is "PENDING" | "PROCESSING" | "DONE" | "FAILED";
export declare const estNiveauGravite: (v: unknown) => v is "LOW" | "MEDIUM" | "HIGH" | "CRITICAL";
export declare const estStatutTache: (v: unknown) => v is "A_FAIRE" | "EN_COURS" | "TERMINEE";
export declare const estStatutAlerte: (v: unknown) => v is "NOUVELLE" | "TRAITEE";
...
//# sourceMappingURL=domaines.d.ts.map