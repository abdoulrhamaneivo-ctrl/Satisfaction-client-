...
import { bandeCES, topBoxCES, scoreEffort100, agregerCES, reconnaitreCES, estEchelleCES, BANDES_CES, } from './ces';
...
describe('scoreEffort100 : effort bas = score haut', () => {
    ...
    test('linéaire et monotone décroissant', () => {
        ...
        const facile = scoreEffort100(1, 5);
        const moyen = scoreEffort100(3, 5);
        const difficile = scoreEffort100(5, 5);
...
//# sourceMappingURL=ces.test.js.map