...
import { estRejouable, estObsolete, aRejouer, estRelancableManuellement, MAX_ATTEMPTS_ANALYSE, } from './etatAnalyse';
const ligne = (status, attempts = 0, minutesEcoulees = 0) => ({
    status,
    attempts,
...
//# sourceMappingURL=etatAnalyse.test.js.map