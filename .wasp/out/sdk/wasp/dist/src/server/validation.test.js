...
import { sanitiserCommentaire, versHttpSiEntreeInvalide, ValiderEntreeErreur, MAX_LONGUEUR_COMMENTAIRE, } from './validation';
describe('P11 — le commentaire trop long est une erreur de saisie, pas une panne', () => {
    test('lève une erreur identifiée COMME erreur de saisie', () => {
        ...
        expect(levee.code).toBe('ENTREE_INVALIDE');
    });
    test('se traduit en 400, pas en 500', () => {
        ...
        expect(http.message).toMatch(/1000/);
    });
