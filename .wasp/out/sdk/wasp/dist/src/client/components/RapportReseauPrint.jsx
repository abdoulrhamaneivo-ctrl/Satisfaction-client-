...
export const RapportReseauPrint = React.forwardRef((props, ref) => {
    ...
    const kpi = (label, valeur, delta, uniteDelta = '') => (<div style={{ flex: 1, border: '1px solid #E9ECEF', borderRadius: 12, padding: '12px 14px', minWidth: 0 }}>
      ...
      {delta !== undefined && (<p style={{ fontSize: 10, fontWeight: 700, color: delta >= 0 ? '#198754' : '#DC3545', margin: '2px 0 0' }}>
          {delta >= 0 ? '▲ +' : '▼ '}{delta}{uniteDelta} vs période précédente
        </p>)}
    </div>);
    return (<div ref={ref} style={{ fontFamily: 'system-ui, sans-serif', color: '#111', background: 'white', padding: 24 }}>
      ...
      <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 11 }}>
        ...
        <tbody>
          {agences.map((a) => (<tr key={a.nom_agence} style={{ borderBottom: '1px solid #E9ECEF' }}>
...
//# sourceMappingURL=RapportReseauPrint.jsx.map