...
export function BrandLogo({ className = "size-8", width, height, mode = 'auto' }) {
    ...
    if (logoUrl && !enEchec) {
        ...
        return (<img src={logoUrl} alt={brandConfig?.platform_name || "Logo"} onError={() => setEnEchec(true)} className={cn("object-contain shrink-0 max-w-full max-h-full", className)} style={hasExplicitSize
                ? {
...
//# sourceMappingURL=BrandLogo.jsx.map