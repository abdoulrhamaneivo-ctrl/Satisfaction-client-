...
const niveauFromSatisfaction = (satisfaction, alertesCritiques) => {
...
export const DashboardSummary = ({ prenom, satisfaction, totalAvis, alertesNouvelles, tachesEnRetard, labelPeriode, isLoading, }) => {
    if (isLoading) {
    ...
    return (<motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, ease: [0.16, 1, 0.3, 1] }} className="ds-hero-glow relative overflow-hidden rounded-3xl border border-border/80 bg-card/95 p-6 shadow-premium sm:p-8 ring-1 ring-primary/5">
      <div className="relative flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex flex-wrap gap-2.5 lg:shrink-0">
          ...
          {totalActions > 0 ? (<SummaryChip label="Actions à traiter" value={String(totalActions)} tone="warning"/>) : (<SummaryChip label="Actions à traiter" value="0" tone="success"/>)}
        </div>
      </div>
...
//# sourceMappingURL=DashboardSummary.jsx.map