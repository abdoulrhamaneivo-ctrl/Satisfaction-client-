...
describe('A4 — audit axe-core du parcours public', () => {
    beforeEach(() => {
        ...
        vi.mocked(getFormDefinitionForGuichet).mockResolvedValue(formDef);
        vi.mocked(soumettreAvis).mockReset();
        vi.mocked(soumettreAvis).mockResolvedValue({ ok: true });
        vi.mocked(completerSoumission).mockReset();
        vi.mocked(completerSoumission).mockResolvedValue({ ok: true });
    });
...
//# sourceMappingURL=CollectePage.a11y.test.jsx.map