...
beforeEach(() => {
    ...
    vi.mocked(getCriteres).mockResolvedValue(CRITERES);
    vi.mocked(getAgenceCriteres).mockResolvedValue(AGENCE_CRITERES);
});
...
//# sourceMappingURL=ConfigurationCriteresPage.a11y.test.jsx.map