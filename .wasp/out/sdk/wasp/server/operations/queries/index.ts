...
// PRIVATE API
export type GetModelesHoraires_ext = typeof getModelesHoraires_ext

// PUBLIC API
export const getModelesHoraires: AuthenticatedOperationFor<GetModelesHoraires_ext> =
  createAuthenticatedOperation(
    getModelesHoraires_ext,
    {
...
// PRIVATE API
export type SuggererPlanning_ext = typeof suggererPlanning_ext

// PUBLIC API
export const suggererPlanning: AuthenticatedOperationFor<SuggererPlanning_ext> =
  createAuthenticatedOperation(
    suggererPlanning_ext,
    {
      AffectationGuichet: prisma.affectationGuichet,
      ModeleHoraire: prisma.modeleHoraire,
      Guichet: prisma.guichet,
...
// PUBLIC API
export const getComparaisonAgences: AuthenticatedOperationFor<GetComparaisonAgences_ext> =
  createAuthenticatedOperation(
    getComparaisonAgences_ext,
    {
      Agence: prisma.agence,
      Reponse: prisma.reponse,
      User: prisma.user,
...
// PRIVATE API
export type GetIndicateursExperience_ext = typeof getIndicateursExperience_ext

// PUBLIC API
export const getIndicateursExperience: AuthenticatedOperationFor<GetIndicateursExperience_ext> =
  createAuthenticatedOperation(
    getIndicateursExperience_ext,
    {
      Reponse: prisma.reponse,
      AnalyseAvisIA: prisma.analyseAvisIA,
      Agence: prisma.agence,
...
// PRIVATE API
export type GetAnalysesGlobales_ext = typeof getAnalysesGlobales_ext

// PUBLIC API
export const getAnalysesGlobales: AuthenticatedOperationFor<GetAnalysesGlobales_ext> =
  createAuthenticatedOperation(
    getAnalysesGlobales_ext,
    {
      GlobalExperienceAnalysis: prisma.globalExperienceAnalysis,
      Entreprise: prisma.entreprise,
    },
