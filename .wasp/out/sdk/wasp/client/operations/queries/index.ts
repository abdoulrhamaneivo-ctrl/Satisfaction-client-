...
// PUBLIC API
export const getComparaisonAgences: QueryFor<GetComparaisonAgences_ext> = createQuery<GetComparaisonAgences_ext>(
  'operations/get-comparaison-agences',
  ['Agence', 'Reponse', 'User', 'Entreprise'],
)
