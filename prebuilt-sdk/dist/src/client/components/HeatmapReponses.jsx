        ...
        <div className="min-w-[820px]">
          ...
          <div className="mt-1 flex flex-col gap-1">
            {ORDRE_JOURS.map((jour) => (<div key={jour} className="grid grid-cols-[3rem_repeat(24,minmax(0,1fr))] items-center gap-1">
                ...
                return (<button key={`${cellule.jour}-${cellule.heure}`} type="button" onMouseEnter={() => setSurvol(cellule)} onFocus={() => setSurvol(cellule)} onMouseLeave={() => setSurvol((s) => (s === cellule ? null : s))} className="aspect-square w-full rounded-[4px] border border-border/40 transition-transform hover:scale-110 hover:z-10" style={{
