...
import { useQuery, assignAgent, updateAffectationGuichet, deleteAffectationGuichet, getGuichets, getAgents, getAffectationsDuJour, } from 'wasp/client/operations';
...
export const PlanningPage = () => {
    ...
    const { data: affectationsDuJour } = useQuery(getAffectationsDuJour, { id_agence: userAgenceId || 0, date: today }, { enabled: !!userAgenceId });
    ...
    return (<RequireEnterpriseRole>
      ...
      <AmbientBackground>
        <div className="mx-auto max-w-7xl p-6 lg:p-10 space-y-8">
          ...
          <PageHeader icon={CalendarClock} eyebrow="Affectations du jour" title="Planning des guichets" description={`Aujourd'hui, ${todayLabel} — affectez chaque agent à son poste et à son créneau horaire.`}/>
                ...
                return (<motion.div key={g.id} initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.35, delay: index * 0.04 }}>
                    <MotionCard className="flex h-full flex-col gap-4 p-5">
                      <div className="flex items-start justify-between gap-3">
                        ...
                        <div className="flex items-center gap-2">
                          {affectationsGuichet.length === 0 && (<span title="Aucun agent affecté aujourd'hui" className="inline-flex items-center gap-1 rounded-full bg-destructive/10 px-2.5 py-1 text-xs font-bold text-destructive">
...
//# sourceMappingURL=PlanningPage.jsx.map