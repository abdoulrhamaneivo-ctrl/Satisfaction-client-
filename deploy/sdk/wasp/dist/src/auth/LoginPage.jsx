...
export function LoginPage() {
    ...
    return (<AuthPageLayout eyebrow="Espace client" title="Connexion à votre espace" subtitle="Retrouvez votre tableau de bord de satisfaction client et suivez vos agences en temps réel." footer={<>
          <span>
            Mot de passe oublié ?{" "}
