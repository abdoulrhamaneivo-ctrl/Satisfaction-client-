...
import { createProviderId, findAuthIdentity, updateAuthIdentityProviderData, getProviderDataWithPassword, } from 'wasp/server/auth';
...
export const updateProfile = async (rawArgs, context) => {
    requireAuth(context);
...
export const changePassword = async (rawArgs, context) => {
    requireAuth(context);
...
export const changeEmail = async (rawArgs, context) => {
    requireAuth(context);
...
//# sourceMappingURL=accountsActions.js.map