...
export const archiverElementsResolusAnciens = async (_args, _context) => {
    ...
    console.log(`[Archivage] ${alertesArchivees.count} alerte(s) et ${tachesArchivees.count} tâche(s) archivées (résolues depuis plus de ${RETENTION_JOURS} jours).`);
...
//# sourceMappingURL=archivageAutomatique.js.map