...
import { Sparkles, AlertTriangle, Info, ArrowRight, Loader2 } from 'lucide-react';
...
export const AIAnalysisBadge = ({ analyse, className }) => {
    if (!analyse)
        return null;
    ...
    if (analyse.status === 'FAILED') {
        return (<div className={cn("inline-flex items-center gap-1.5 px-2 py-0.5 rounded-md text-[10px] font-semibold bg-muted text-muted-foreground border border-border/50", className)}>
...
//# sourceMappingURL=AIAnalysisBadge.jsx.map