...
export const DataTableRow = ({ children, onClick, className = '', }) => (<tr onClick={onClick} className={cn("border-b border-border/60 last:border-0 transition-colors duration-150 hover:bg-primary/5", onClick && "cursor-pointer active:bg-primary/10", className)}>
    {children}
  </tr>);
